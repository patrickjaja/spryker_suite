...
$yvesHost = sprintf('%s.www.%s.local', $storeLowerCase, $domain);
$glueHost = sprintf('%s.glue.%s.local', $storeLowerCase, $domain);
$zedHost = sprintf('%s.zed.%s.local', $storeLowerCase, $domain);
